...
if ($raw) {
    ui_sp('Дискретная таблица');
    ui_gf();
    ui_stfs();
    
    ui_sfs('Бюджет','w100');
    /*ui_trlink('','Лечебный','discrete.php?fc=1&tf=1&ef=1');
    ui_trlink('','Мед-проф','discrete.php?fc=2&tf=1&ef=1');
    ui_trlink('','Педиатрический','discrete.php?fc=3&tf=1&ef=1');
    ui_trlink('','Стоматология','discrete.php?fc=4&tf=1&ef=1');
    ui_trlink('','Воен-мед','discrete.php?fc=5&tf=1&ef=1');
    ui_trlink('','Фарма дневная','discrete.php?fc=6&tf=1&ef=1');
    ui_trlink('','Фарма заочная','discrete.php?fc=6&tf=2&ef=1');*/
    ui_trlink('','Лечебный','discrete.php?fc=1&tf=1&ef=1');
    ui_trlink('','Мед-проф','discrete.php?fc=2&tf=1&ef=1');
    ui_trlink('','Педиатрический','discrete.php?fc=3&tf=1&ef=1');
    ui_trlink('','Стоматология','discrete.php?fc=4&tf=1&ef=1');
    ui_trlink('','Фарма','discrete.php?fc=6&tf=1&ef=1');
    ui_trlink('','Воен-мед ВС','discrete.php?fc=8&tf=1&ef=1');
    ui_trlink('','Воен-мед ВВ','discrete.php?fc=9&tf=1&ef=1');
    ui_efs();
    ...
    /*ui_trlink('','Лечебный','discrete.php?fc=1&tf=1&ef=2');
    ui_trlink('','Мед-проф','discrete.php?fc=2&tf=1&ef=2');
    ui_trlink('','Педиатрический','discrete.php?fc=3&tf=1&ef=2');
    ui_trlink('','Стоматология','discrete.php?fc=4&tf=1&ef=2');
    ui_trlink('','Воен-мед','discrete.php?fc=5&tf=1&ef=2');
    ui_trlink('','Фарма дневная','discrete.php?fc=6&tf=1&ef=2');
    ui_trlink('','Фарма заочная','discrete.php?fc=6&tf=2&ef=2');*/
    ui_trlink('','Лечебный','discrete.php?fc=1&tf=1&ef=2');
    ui_trlink('','Мед-проф','discrete.php?fc=2&tf=1&ef=2');
    ui_trlink('','Педиатрический','discrete.php?fc=3&tf=1&ef=2');
    ui_trlink('','Стоматология','discrete.php?fc=4&tf=1&ef=2');
    ui_trlink('','Фарма дневная','discrete.php?fc=6&tf=1&ef=2');
    ui_trlink('','Фарма заочная','discrete.php?fc=6&tf=2&ef=2');
    ui_trlink('','Профориентации','discrete.php?fc=7&tf=1&ef=2');
    ui_trlink('','МФИУ (Леч., рус.)','discrete.php?fc=10&tf=1&ef=2');
    ui_trlink('','МФИУ (Леч., англ.)','discrete.php?fc=11&tf=1&ef=2');
    ui_trlink('','МФИУ (Стом., рус.)','discrete.php?fc=12&tf=1&ef=2');
    ui_trlink('','МФИУ (Стом., англ.)','discrete.php?fc=13&tf=1&ef=2');
    ui_trlink('','МФИУ (Мед-проф., рус.)','discrete.php?fc=14&tf=1&ef=2');
    ui_trlink('','МФИУ (Фарм., рус.)','discrete.php?fc=15&tf=1&ef=2');
    ui_trlink('','МФИУ (Фарм., англ.)','discrete.php?fc=16&tf=1&ef=2');
    ui_efs();
    ui_etfs();
    ui_ef0();
}
...
$sql = <<<EOF
    SELECT 
        (SELECT SUM(total) FROM `db_planform` WHERE (1 $wfcp $wtf $wefp)) as plan,
        (SELECT sum(db_plancell.plan)  FROM db_plancell  WHERE (1 $wfcp)) as cell
EOF;
...
$dt = date('H:i');
$dd = date('d.m.Y');
//ui_par("Сверка документов завершена. Данные на 27.07.2012 ");
ui_par("Данные на  $dt $dd");
//ui_par("Данные на  18:00 25.07.2012");
ui_par(ui_sap($fc_arr,$fc). ' / ' . ui_sap($tf_arr,$tf) .' / '.ui_sap($ef_arr,$ef));
...
$sql = <<<EOF
    (SELECT 800 as t,
    count(if(`target`=6,`total`,null)) tall,
    ...
    UNION 
    (SELECT 700 as t,
    count(if(`target`=4,`total`,null)) tall,
    ...
    UNION 
    (SELECT 600 as t,
    count(if(`target`=5,`total`,null)) tall,
    ...
    UNION 
    (SELECT 500 as t,
    count(if(`target`=2,`total`,null)) tall,
    ...
    count(if(`target` IN (3,7),`total`,null)) as tall,
    count(if(`target` IN (3,7) AND `target_type`=1,`total`,null)) as t1,
    count(if(`target` IN (3,7) AND `target_type`=2,`total`,null)) as t2,
    ...
    FROM $target_table WHERE ($fid $wct AND (`target`=3 or `target`=1 or `target` = 7) $wfc $wtf $wef) GROUP BY `t` ) ORDER BY `t` DESC;
EOF;
