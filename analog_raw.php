...
if ($raw) {
    ui_sp('Аналоговая таблица (Дела)');
    ui_gf();
    ui_stfs();
    ui_sfs('Бюджет','w100');
    /*ui_trlink('','Лечебный','analog_raw.php?fc=1&tf=1&ef=1');
    ui_trlink('','Мед-проф','analog_raw.php?fc=2&tf=1&ef=1');
    ui_trlink('','Педиатрический','analog_raw.php?fc=3&tf=1&ef=1');
    ui_trlink('','Стоматология','analog_raw.php?fc=4&tf=1&ef=1');
    ui_trlink('','Воен-мед','analog_raw.php?fc=5&tf=1&ef=1');
    ui_trlink('','Фарма дневная','analog_raw.php?fc=6&tf=1&ef=1');
    ui_trlink('','Фарма заочная','analog_raw.php?fc=6&tf=2&ef=1');*/
    ui_trlink('','Лечебный','analog_raw.php?fc=1&tf=1&ef=1');
    ui_trlink('','Мед-проф','analog_raw.php?fc=2&tf=1&ef=1');
    ui_trlink('','Педиатрический','analog_raw.php?fc=3&tf=1&ef=1');
    ui_trlink('','Стоматология','analog_raw.php?fc=4&tf=1&ef=1');
    ui_trlink('','Фарма','analog_raw.php?fc=6&tf=1&ef=1');
    ui_trlink('','Воен-мед ВС','analog_raw.php?fc=8&tf=1&ef=1');
    ui_trlink('','Воен-мед ВВ','analog_raw.php?fc=9&tf=1&ef=1');
    ...
    /*ui_trlink('','Лечебный','analog_raw.php?fc=1&tf=1&ef=2');
    ui_trlink('','Мед-проф','analog_raw.php?fc=2&tf=1&ef=2');
    ui_trlink('','Педиатрический','analog_raw.php?fc=3&tf=1&ef=2');
    ui_trlink('','Стоматология','analog_raw.php?fc=4&tf=1&ef=2');
    ui_trlink('','Воен-мед','analog_raw.php?fc=5&tf=1&ef=2');
    ui_trlink('','Фарма дневная','analog_raw.php?fc=6&tf=1&ef=2');
    ui_trlink('','Фарма заочная','analog_raw.php?fc=6&tf=2&ef=2');*/
    ui_trlink('','Лечебный','analog_raw.php?fc=1&tf=1&ef=2');
    ui_trlink('','Мед-проф','analog_raw.php?fc=2&tf=1&ef=2');
    ui_trlink('','Педиатрический','analog_raw.php?fc=3&tf=1&ef=2');
    ui_trlink('','Стоматология','analog_raw.php?fc=4&tf=1&ef=2');
    ui_trlink('','Фарма дневная','analog_raw.php?fc=6&tf=1&ef=2');
    ui_trlink('','Фарма заочная','analog_raw.php?fc=6&tf=2&ef=2');
    ui_trlink('','Профориентации','analog_raw.php?fc=7&tf=1&ef=2');
    ui_trlink('','МФИУ (Леч., рус.)','analog_raw.php?fc=10&tf=1&ef=2');
    ui_trlink('','МФИУ (Леч., англ.)','analog_raw.php?fc=11&tf=1&ef=2');
    ui_trlink('','МФИУ (Стом., рус.)','analog_raw.php?fc=12&tf=1&ef=2');
    ui_trlink('','МФИУ (Стом., англ.)','analog_raw.php?fc=13&tf=1&ef=2');
    ui_trlink('','МФИУ (Мед-проф., рус.)','analog_raw.php?fc=14&tf=1&ef=2');
    ui_trlink('','МФИУ (Фарм., рус.)','analog_raw.php?fc=15&tf=1&ef=2');
    ui_trlink('','МФИУ (Фарм., англ.)','analog_raw.php?fc=16&tf=1&ef=2');
...
$sql = <<<EOF
    (SELECT 800 as t,
    group_concat(if(`target`=6 ,`delo_name`,null) ORDER BY `total` SEPARATOR '<br />') tall,
    ...
    UNION
    (SELECT 700 as t,
    group_concat(if(`target`=4 ,`delo_name`,null) ORDER BY `total` SEPARATOR '<br />') tall,
    ...
    UNION 
    (SELECT 600 as t,
    group_concat(if(`target`=5 ,`delo_name`,null) ORDER BY `total` SEPARATOR '<br />') tall,
    ...
    UNION 
    (SELECT 500 as t,
    group_concat(if(`target`=2 ,`delo_name`,null) ORDER BY `total` SEPARATOR '<br />') tall,
